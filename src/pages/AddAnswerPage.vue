...
<!--                         <v-select
                        ...
                        >
                            <template slot="selection" scope="data">
                                ...
                                >
                                    <strong>{{ data.item.words[0] + ' ' + data.item.words[1] }}</strong>&nbsp;
                                    <span>({{data.item.link}})</span>
                                </v-chip>
                            </template>
                        </v-select> -->
                        <template>
                            ...
                            >
                                ...
                                <template slot="footer">
                                    ...
                                    <td style="padding-left: 20px"><v-text-field @keyup.enter="addLink" v-model="newWord" label="Слово"></v-text-field></td>
                                    <td style="padding-left: 10% ;width: 10px"><v-text-field @keyup.enter="addLink" v-model="newWeight" label="Вес"></v-text-field></td>
